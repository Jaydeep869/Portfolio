...
export const ExperienceSection: React.FC = () => {
  return (
    <section
      id="experience"
      className={cn(
        'w-full min-h-[100svh] flex flex-col justify-start items-center px-6 sm:px-10 lg:px-14 xl:px-18 pt-20 sm:pt-24 lg:pt-28 pb-28 bg-black select-none overflow-x-hidden'
      )}
    >
      ...
      <div className="max-w-[1650px] w-full mx-auto flex flex-col">
        ...
        {/* Bottom Divider */}
        <div className="hidden md:block w-screen relative left-1/2 -translate-x-1/2 h-[1px] bg-gradient-to-r from-transparent via-white/15 to-transparent pointer-events-none" />
        <div className="block md:hidden w-full h-[1.5px] bg-[#857b76]/60 mt-1" />
      </div>
    </section>
  );
};
